<!-- Source: https://github.com/tailwindcss/designing-with-tailwindcss/blob/master/04-building-a-dropdown-menu/04-adapting-the-dropdown-for-mobile/src/components/AccountDropdown.vue -->
<template>
  <div class="relative">
    <button
      @click="isOpen = !isOpen"
